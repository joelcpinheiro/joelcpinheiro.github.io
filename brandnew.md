...
# Status: My solution was create an account <a href="https://developers.redhat.com/developer-sandbox" target="_blank">here</a> and try for 30 days play a lot on Developer Sandbox for Red Hat OpenShift.
...
> I notice that is missing contents like as I had found:
> Ansible(weight: 8) - Have nothing
> JenkinsFile
> .dockerignore
> Modern Software Development (weight: 6) - Increase and give more enphasys on this section
...
My point of view about the last webinar event called "AWS Cloud Practitioner Essentials Day", at last weekend(saturday), was a good overview, but far from sufficient to be a preparatory for CLF-C01 Exam, because have much content to explain yet.